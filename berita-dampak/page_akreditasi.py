...
def render() -> None:
    ...
    if mode == "LED":
        ...
        st.caption(
            "Narasi evaluatif per Kriteria A-D (siklus PPEPP), sesuai akreditasi/docs/Data_Requirements_LED_LKPS_MEI.md. "
        ...
        st.caption(
            "Tabel data mentah per Bagian 1-6, sesuai akreditasi/docs/Data_Requirements_LED_LKPS_MEI.md. "
